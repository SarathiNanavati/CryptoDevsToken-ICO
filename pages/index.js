...
import {
  CRYPTODEV_NFT_CONTRACT_ABI,
  CRYPTODEV_NFT_CONTRACT_ADDRESS,
  CRYPTODEV_TOKEN_CONTRACT_ABI,
    ...
    try {
      ...
      if (balance === zero) {
        ...
        for (var index = 0; index < balance; index++) {
          const tokenId = await nftContract.tokenOfOwnerByIndex(address, index);
      ...
      console.error(`getTokensToBeClaimed ${err}`);
      setTokensToBeClaimed(zero);
    }
  };
